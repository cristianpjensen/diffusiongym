...
from flow_gym import reward_registry
from flow_gym.molecules import BatchedMoleculeReward
    ...
    def compute_rewards(self, mols: list[Chem.Mol]) -> torch.Tensor:
        ...
        with temporary_workdir():
            ...
            for i, mol in enumerate(mols):
                ...
                if not success:
                    print("Warning: Meeko failed to prepare ligand:", error_msg)
                    continue
            ...
            for i, mol in enumerate(mols):
                ...
                with open(f"ligands/ligand_{i:05d}.dlg", "r") as f:
                    for line in f:
